...
const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Privacy Policy - Naga Codex AI Chess</title>
      </Head>
      <div className="min-h-screen bg-slate-800 text-slate-200 p-4 sm:p-8 flex flex-col items-center">
        <div className="w-full max-w-3xl bg-slate-700 p-6 sm:p-8 rounded-lg shadow-xl">
          ...
          <section className="mb-6 space-y-3">
            ...
            <p>For more information about how we use cookies, please see our <Link href="/cookie" legacyBehavior><a className="text-emerald-400 hover:underline">Cookie Policy</a></Link>.</p>
          </section>
